...
class TerjualAdapter : RecyclerView.Adapter<TerjualAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_adapter_terjual, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        with(holder.itemView) {
            card_daftar_jual_terjual_nama_seller.text =
                "Nama penjual: ${listProdukTerjual!![position].Product.User.full_name}"
